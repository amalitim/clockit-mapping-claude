...
def predict_file():
    ...
    try:
        ...
        print(f"Filename received: {filename}, check_only: {check_only}")
        ...
        # If this is just a file existence check, return success
        if check_only:
            print("File existence check passed")
            return jsonify({'success': True, 'message': 'File exists and ready for prediction'})
